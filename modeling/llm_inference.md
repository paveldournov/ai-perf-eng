...
- [Inference workloads](../workloads/inference/index.md) — the production serving stack that applies this model: [basics](../workloads/inference/basics.md), [optimization](../workloads/inference/optimization.md)
